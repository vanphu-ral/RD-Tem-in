 ...
 */
@Schema(description = "Entity VendorTemDetail")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class VendorTemDetailDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VendorTemDetailDTO)) {
            return false;
        }

        VendorTemDetailDTO vendorTemDetailDTO = (VendorTemDetailDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, vendorTemDetailDTO.id);
    }
