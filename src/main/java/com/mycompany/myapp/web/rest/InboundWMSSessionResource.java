...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.InboundWMSSession}.
 */
@RestController
...
public class InboundWMSSessionResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new inboundWMSSessionDTO, or with status {@code 400 (Bad Request)} if the inboundWMSSession has already an ID.
    ...
    /**
     * {@code PUT  /inbound-wms-sessions/:id} : Updates an existing inboundWMSSession.
     *
     * @param id the id of the inboundWMSSessionDTO to save.
     * @param inboundWMSSessionDTO the inboundWMSSessionDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated inboundWMSSessionDTO,
     * or with status {@code 400 (Bad Request)} if the inboundWMSSessionDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the inboundWMSSessionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    /**
     * {@code PATCH  /inbound-wms-sessions/:id} : Partial updates given fields of an existing inboundWMSSession, field will ignore if it is null
     *
     * @param id the id of the inboundWMSSessionDTO to save.
     * @param inboundWMSSessionDTO the inboundWMSSessionDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated inboundWMSSessionDTO,
     * or with status {@code 400 (Bad Request)} if the inboundWMSSessionDTO is not valid,
     * or with status {@code 404 (Not Found)} if the inboundWMSSessionDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the inboundWMSSessionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of inboundWMSSessions in body.
     */
    @GetMapping("")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the inboundWMSSessionDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    ...
    /**
     * {@code DELETE  /inbound-wms-sessions/:id} : delete the "id" inboundWMSSession.
     *
