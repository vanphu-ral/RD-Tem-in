...
import { ListProductOfRequest } from "app/entities/generate-tem-in/models/list-product-of-request.model";
...
export class PreviewOrderDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<PreviewOrderDialogComponent>) {}
