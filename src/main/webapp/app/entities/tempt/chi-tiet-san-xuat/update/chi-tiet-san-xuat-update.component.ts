...
export class ChiTietSanXuatUpdateComponent implements OnInit {
  ...
  save(): void {
    ...
    if (chiTietSanXuat.id !== undefined) {
      this.subscribeToSaveResponse(
        this.chiTietSanXuatService.update(chiTietSanXuat),
      );
    } else {
      this.subscribeToSaveResponse(
        this.chiTietSanXuatService.create(chiTietSanXuat),
      );
    }
  }
  ...
  protected subscribeToSaveResponse(
    result: Observable<HttpResponse<IChiTietSanXuat>>,
  ): void {
    ...
    this.sanXuatHangNgayService
      ...
      .subscribe(
        (sanXuatHangNgays: ISanXuatHangNgay[]) =>
          (this.sanXuatHangNgaysSharedCollection = sanXuatHangNgays),
      );
  }
