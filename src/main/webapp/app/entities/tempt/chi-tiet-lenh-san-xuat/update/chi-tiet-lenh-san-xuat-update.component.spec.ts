...
describe("ChiTietLenhSanXuat Management Update Component", () => {
  ...
  describe("ngOnInit", () => {
    it("Should call LenhSanXuat query and add missing value", () => {
      ...
      jest
        .spyOn(lenhSanXuatService, "query")
        .mockReturnValue(of(new HttpResponse({ body: lenhSanXuatCollection })));
      const additionalLenhSanXuats = [lenhSanXuat];
      const expectedCollection: ILenhSanXuat[] = [
        ...additionalLenhSanXuats,
        ...lenhSanXuatCollection,
      ];
      jest
        .spyOn(lenhSanXuatService, "addLenhSanXuatToCollectionIfMissing")
