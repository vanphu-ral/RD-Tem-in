...
public class VendorTemDetailTestSamples {
    ...
    public static VendorTemDetail getVendorTemDetailSample1() {
        return new VendorTemDetail()
            ...
            .sapCode("sapCode1")
            .vendorQrCode("vendorQrCode1")
            .status("status1")
            .createdBy("createdBy1")
            .updatedBy("updatedBy1");
    }

    public static VendorTemDetail getVendorTemDetailSample2() {
        return new VendorTemDetail()
            .id(2L)
            .reelId("reelId2")
            ...
            .sapCode("sapCode2")
            .vendorQrCode("vendorQrCode2")
            .status("status2")
            .createdBy("createdBy2")
            .updatedBy("updatedBy2");
    }

    public static VendorTemDetail getVendorTemDetailRandomSampleGenerator() {
        return new VendorTemDetail()
            ...
            .vendorQrCode(UUID.randomUUID().toString())
